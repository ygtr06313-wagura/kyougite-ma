...
async def startup_event():
    ...
    FEATURES_SAVE_PATH = '/content/all_reference_features.pt'
    PATHS_SAVE_PATH = '/content/reference_image_paths.pkl'
    ...
    try:
        ...
        # 修正: 空のテンソルでも正しい特徴量次元を指定する
        all_reference_features = torch.empty(0, 128) # 128はSimpleCNNの最終特徴量次元
